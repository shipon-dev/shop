      ...
      <View className="flex-1 ">
        <DrawerContentScrollView>
          <View className="flex flex-row gap-5 items-center justify-start border-b-2 border-muted mx-2 pb-5 mb-5">
            <Avatar alt="Shipon" className="w-20 h-20">
              ...
              <AvatarFallback>
                <Text className="text-foreground text-3xl">{Name.charAt(0)}</Text>
              </AvatarFallback>
            </Avatar>
            <View>
              <CardTitle numberOfLines={1} className="line-clamp-1 text-center pr-24">
                {Name}
              </CardTitle>
              <View className="flex-row items-center">
                <CardDescription numberOfLines={1} className="text-base font-semibold">
                  Developer
                </CardDescription>
                <Tooltip delayDuration={150}>
                  ...
                  <TooltipContent className="py-2 px-4 shadow">
                    <Text className="native:text-lg text-foreground">Freelancer</Text>
                  </TooltipContent>
                </Tooltip>
              </View>
            </View>
              ...
              return (
                <TouchableOpacity
                  ...
                  <View className="w-10 flex">
                    <item.icon
                      className={cn('w-6 h-6 text-foreground', isActive && 'text-white')}
                    />
                  </View>
                  <Text
                    numberOfLines={1}
        ...
        <View className="pb-10 mx-2">
          <TouchableOpacity
            ...
            <Text numberOfLines={1} className={cn('text-xl font-medium text-foreground pr-10')}>
              Logout
            </Text>
          </TouchableOpacity>
        </View>
